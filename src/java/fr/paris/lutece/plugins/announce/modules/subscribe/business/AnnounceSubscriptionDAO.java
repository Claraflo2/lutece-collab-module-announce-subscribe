...
public class AnnounceSubscriptionDAO implements IAnnounceSubscriptionDAO
{
	...
	private static final String SQL_QUERY_SELECT_BY_CATEGORY = SQL_QUERY_SELECT
			+ CONSTANT_WHERE + SQL_FILTER_PROVIDER + CONSTANT_AND + SQL_FILTER_SUBSCRIPTION_KEY
			+ CONSTANT_AND + SQL_FILTER_ID_SUBSCRIBED_RESOURCE;

	private static final String SQL_QUERY_SELECT_BY_USER = SQL_QUERY_SELECT
			+ CONSTANT_WHERE + SQL_FILTER_PROVIDER + CONSTANT_AND + SQL_FILTER_SUBSCRIPTION_KEY
			+ CONSTANT_AND + SQL_FILTER_ID_SUBSCRIBED_RESOURCE;

	private static final String SQL_QUERY_SELECT_ALL_FILTERS = SQL_QUERY_SELECT
			+ CONSTANT_WHERE + SQL_FILTER_PROVIDER + CONSTANT_AND + SQL_FILTER_SUBSCRIPTION_KEY;
	 ...
	 * @param daoUtil The DAOUtil positioned on the current row
